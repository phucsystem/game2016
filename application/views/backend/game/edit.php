...
<script>
    ...
    function saveGame() {
        $.ajax({
            url: "<?php echo site_url('master/game/edit') ?>/" + editGameId,
            method: "POST",
            dataType: 'json',
            data: {
                'name': $('#game-name').val(),
    ...
    var roundNumber = <?= $this->data['game']['number_of_round'] ?>;
                    ...
                    <div class="panel-body">
                        <div class="">
                            <div class="form-group ">
                                ...
                                <input class="form-control validate[required]" placeholder="" name='name' value="<?= $game['name'] ?>" id="game-name" >
                                <input type="hidden" name="number_of_round" value="<?= $this->data['game']['number_of_round'] ?>" id="number-of-round">
                            </div>
                            <div class="form-group ">
                                <label>Recycle Round</label>
                                <input class="form-control validate[required,custom[number]]" placeholder="" name='recycle_round' id="recycle-round" value="<?= $game['recycle_round'] ?>">
                            </div>
                        </div>
