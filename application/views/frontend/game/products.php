<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <?= form_open('game/products', array('class' => 'form-validate', 'id' => 'form-game-development')); ?>

        <!-- Page Heading -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Product development  <small>  </small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th>Component</th>
                                        <th>Material</th>
                                        <th class="hidden">In House Manufacturing</th>
                                ...
                                <tbody>
                                    <?php foreach ($this->data['components'] as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="product[component][<?= $value['id'] ?>]" onchange="selectComponent(<?= $key ?>, <?= $value['inhouse_manufacturing'] ?>)" class="form-control custom-select component-product <?php
                            ...
                            <div >
                                <button type="button" onclick="moveToNextStep('<?= STEP_COMPONENTS ?>')" class="btn btn-default pull-right RbtnMargin">Next Phase</button>
                                <!-- <button type="button" onclick="updateProduct()" class="btn btn-primary pull-right RbtnMargin">Update Product</button> -->
                                <button type="button" class="btn btn-success pull-right "  onclick="document.location.href = '<?= site_url('game/development') ?>'">Develop new product</button>
                            </div>
...
<script>
        ...
        if (productId > 0) {
            ...
            $.ajax({
                ...
                $.each(data.info.component, function (key, value) {
                    $('#component' + key).val(value.material_id).change();
                    console.log(key);
                    // Update product point
                    selectComponent(key, value.inhouse);
                });
                updateProductCost();
    ...
    function updateProduct() {
        common.confirmDialog('Do you want to update this product?', function () {
